package com.snomyc.base.persistence;
 ...
 * 
 * 类名称：Collections3<br>
 * 类描述：Collections工具集.<br>
 * 在JDK的Collections和Guava的Collections2后, 命名为Collections3.<br>
 * 函数主要由两部分组成，一是自反射提取元素的功能，二是源自Apache Commons Collection, 争取不用在项目里引入它。<br>
 * @version v1.0
 *
 */
